...
det3x3(T m00, T m01, T m02, T m10, T m11, T m12, T m20, T m21, T m22) {
    return m00 * (m11 * m22 - m12 * m21) - m10 * (m01 * m22 - m02 - m21) +
           m20 * (m01 * m12 - m02 * m11);
}

template <typename T>
__device__ __forceinline__ void matmul3x3_3x1(T m00,
                                              T m01,
                                              T m02,
                                              T m10,
                                              T m11,
...
template <typename T>
__device__ __forceinline__ void matmul3x3_3x3(T a00,
                                              T a01,
                                              T a02,
                                              T a10,
                                              T a11,
...
template <typename T>
__device__ __forceinline__ void solve_svd3x3(T &a11,
                                             T &a12,
                                             T &a13,
                                             T &a21,
                                             T &a22,
