...
// void nms_kernel(const int num_boxes,
...
// const int row_size =
//         fminf(num_boxes - block_row_idx * NMS_BLOCK_SIZE,
//         NMS_BLOCK_SIZE);
// // Local block col size.
// const int col_size =
//         fminf(num_boxes - block_col_idx * NMS_BLOCK_SIZE,
//         NMS_BLOCK_SIZE);
...
// //
// // Result:
// // mask[i, j] is a 64-bit integer where mask[i, j][k] (k counted from
// right)
...
void NmsCPUKernel(const float *boxes,
    ...
    // nms_kernel<<<blocks, threads>>>(num_boxes, nms_overlap_thresh, boxes,
    // mask);
